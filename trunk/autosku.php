...
jQuery(function($){
	if(jQuery("#product-type").val() == "variable") jQuery('<i class="icon icon-cog assegnaSku" title="<?php echo __("Assign code to variations", "autosku") ?>"></i>').insertAfter("#general_product_data #_sku").click(assegnaSku);
});
</script>
<?php
	}
